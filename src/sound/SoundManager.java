...
public class SoundManager extends ThreadPool {
    ...
    */
    ...
    /**
        ...
        This constructor will use default Sound Engine
    */
    public SoundManager(AudioFormat playbackFormat,
    ...
    /*
     * Set a specify mixer on Sound Manager
     */
    public SoundManager(AudioFormat playbackFormat, Mixer mixer, int maxLines){
    	super(maxLines);
...
//        return mixer.getMaxLines(lineInfo);
    ...
    */
    public AudioInputStream getAudioInputStream(String filename) {
    	return getAudioInputStream(ResourceLoader.loadInputStream(filename));
